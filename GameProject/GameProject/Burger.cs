    ...
    public class Burger
    {
        ...
        public void Update(GameTime gameTime, KeyboardState keyboard)
        {
            ...
            if (this.health > 0)
            {
                ...
                {
                    this.drawRectangle.Y -= GameConstants.BurgerMovementAmount;
                }
                ...
                {
                    this.drawRectangle.X -= GameConstants.BurgerMovementAmount;
                }
                ...
                if (!canShoot)
                {
                    ...
                    if ((elapsedCooldownMilliseconds >= GameConstants.BurgerTotalCooldownMilliseconds) || (keyboard.IsKeyUp(Keys.Space) && !canShoot))
                    {
                        canShoot = true;
